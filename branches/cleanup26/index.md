...
| | |
| :--- | :--- |
| *Official URL*:http://smart.who.int/dak-empty/ImplementationGuide/smart.who.int.dak-empty | *Version*:0.1.0 |
| Draft as of 2026-08-04 | *Computable Name*:DAKEmpty |
...
**[Add content here. You could use as reference the previously published DAKs]**
...
The DAK for **[insert health domain here]** and the associated implementations tools can be found here:
...
For more license details please see the [license page](https://smart.who.int/dak-<mark>[health domain abbreviation]</mark>/license.md).
...
* Creating an issue on GitHub [dak-empty repository](https://github.com/WorldHealthOrganization/dak-empty)
...
```json
{
  ...
  "id" : "smart.who.int.dak-empty",
  "meta" : {
    "profile" : ["SMARTImplementationGuide"]
  },
  "url" : "http://smart.who.int/dak-empty/ImplementationGuide/smart.who.int.dak-empty",
  "version" : "0.1.0",
  "name" : "DAKEmpty",
  "title" : "SMART DAK Empty",
  "status" : "draft",
  "date" : "2026-08-04T14:40:36+00:00",
  "publisher" : "WHO",
  "contact" : [{
    "name" : "WHO",
    "telecom" : [{
  ...
  "description" : "An empty Digital Adaptation Kit (DAK) Implementation Guide to be used as a starting point for publishing SMART DAK content",
  "packageId" : "smart.who.int.dak-empty",
  "license" : "CC0-1.0",
  "fhirVersion" : ["4.0.1"],
  "dependsOn" : [{
    "id" : "hl7tx",
  ...
  "definition" : {
    ...
    },
    {
      ...
      {
        "url" : "value",
        "valueString" : "http://smart.who.int/dak-empty/history.html"
      }],
      "url" : "http://hl7.org/fhir/tools/StructureDefinition/ig-parameter"
    },
    {
