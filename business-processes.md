# Business Processes - SMART DAK Empty v0.1.0
...
For more details, please see component 4 "Generic business processes and workflows" in the WHO Digital Adaptation Kit (DAK) for **[insert health domain here]**.

The source files of the business processes designed for this DAK can be downloaded [here](**[health domain abbreviation]** DAK_BPMN files.zip).
